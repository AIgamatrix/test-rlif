...
LOG_DIR="/home/llama/test-rlif/checkpoints/logs/20250824-052823"
...
# 运行rent-rl
echo "启动rentrl训练..."
bash rent-train.sh > "$LOG_DIR/rent_train.log" 2>&1
echo "rentrl训练已完成，日志文件: $LOG_DIR/rent_train.log"
